...
const mdiIconMap = {
  ...
  'mdi-arrange-bring-forward': mdiArrangeBringForward,
  'mdi-arrange-send-backward': mdiArrangeSendBackward,
  'mdi-arrow-right-bold': mdiArrowRightBold,
  'mdi-axis-z-rotate-clockwise': mdiAxisZRotateClockwise,
  'mdi-bell-ring-outline': mdiBellRingOutline,
  'mdi-brightness-6': mdiBrightness6,
  'mdi-broom': mdiBroom,
  'mdi-camera': mdiCamera,
  'mdi-cog-transfer': mdiCogTransfer,
  ...
  'mdi-sun-clock-outline': mdiSunClockOutline,
  'mdi-tag': mdiTag,
  'mdi-undo': mdiUndo,
